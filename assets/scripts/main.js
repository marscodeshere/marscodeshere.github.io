...
function init(){
    ...
    if (page == "Plans.html") {
        ...
        var artArray = ["../../assets/images/3dmodel3.png", "../../assets/images/3dmodel2.png", "../../assets/images/3dmodel1.png", "../../assets/images/3dprint1.JPG", "../../assets/images/3dprint2.JPG", "../../assets/images/cosplay8.JPG", "../../assets/images/cosplay7.JPG", "../../assets/images/cosplay6.JPG", "../../assets/images/cosplay1.JPG", "../../assets/images/cosplay2.JPG", "../../assets/images/cosplay3.PNG", "../../assets/images/cosplay4.JPG", "../../assets/images/cosplay5.JPG"];
        var artDesc1 = "Zagreus Cosplay from Hades Video Game <br> Created 2022 Updated in 2023 <br> Eva Foam, Acrylic Paint, Cardboard, Sewn Fabric <br> Updated with 3d printed pieces and new weapon";                
        var artDesc2 = ["3D Models <br> Created by using Blender Software in 2023 <br> Each project took roughly a week to complete in Blender <br> Average print time was 10 hours per print"];
        var artDesc = [artDesc2, artDesc2, artDesc2, artDesc2, artDesc2, artDesc1, artDesc1, artDesc1, artDesc1, artDesc1, artDesc1, artDesc1, artDesc1];
...
function buildArtGallery(artA, artD, collabA, collabD, commissA, commissD) {
    ...
    for(var i = 0; i < artA.length; i++) {
        ...
        artHTML += "<img src='" + artA[i] + "' alt='Image Gallery'></a><div><p>" + artD[i] + "</p></div></div>";
