...
function init(){
    ...
    if (page == "Plans.html") {
        ...
        var artDesc2 = ["3D Models <br> Created by using Blender Software <br> 2023 <br> Each project took roughly a week to complete in Blender <br> Average print time was 10 hours per print"];
